...
from .losses import DBOT_Sinkhorn_Loss, Cross_Entropy_Loss, Entropic_Sinkhorn_Loss, Gromov_OT_Loss, InfoNCE_Loss, Triplet_Loss, UOTBadmmLoss
...
_loss_factory = {
    ...
    'gromov_ot': Gromov_OT_Loss,
    'entropic_sinkhorn': Entropic_Sinkhorn_Loss,
    'triplet': Triplet_Loss,
    'uot_badmm': UOTBadmmLoss,
}
...
class ClipLoss(nn.Module):
    ...
    def forward(self, image_features, text_features, logit_scale, output_dict=False):
        ...
        labels = self.get_ground_truth(all_image_features.device, all_image_features.shape[0])
